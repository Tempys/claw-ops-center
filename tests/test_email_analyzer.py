...
async def test_email_analyze_node_classifies_signals():
    signals = [
        {
            "url": "https://mail.example.com/autogen",
            "title": "AutoGen v0.5 newsletter",
            "classification": "other",
            "summary": "New multi-agent release with tool-use",
            "source": "email",
        },
        {
            "url": "https://mail.example.com/sale",
            "title": "50% off our new course!",
            "classification": "other",
            "summary": "Limited time promotion",
            "source": "email",
        },
    ]
...
async def test_email_analyze_node_uses_email_system_prompt():
    signals = [
        {
            "url": "https://mail.example.com/lora",
            "title": "LLM fine-tuning guide",
            "classification": "other",
            "summary": "Step-by-step LoRA tutorial",
            "source": "email",
        },
    ]
    ...
    with patch("news.nodes.analyzer._client", mock_client):
        from news.nodes.email_analyzer import _EMAIL_SYSTEM, email_analyze_node
